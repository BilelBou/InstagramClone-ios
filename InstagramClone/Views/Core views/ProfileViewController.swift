...
class ProfileViewController: UIViewController {
    ...
    private lazy var collectionViewLayout = UICollectionViewFlowLayout()..{
        ...
        $0.sectionInset = UIEdgeInsets(top: 0, left: 1, bottom: 0, right: 1)
    ...
    private lazy var collectionView = UICollectionView(frame: .zero, collectionViewLayout: collectionViewLayout)..{
        ...
        $0.register(ProfileInfoHeaderCollectionReusableView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: ProfileInfoHeaderCollectionReusableView.identifier)
        $0.register(ProfileTabsCollectionReusableView.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: ProfileTabsCollectionReusableView.identifier)
    }
...
extension ProfileViewController: ProfileInfoHeaderCollectionReusableViewDelegate {
    ...
    func profileHeaderDidTapFollowersButton(_ header: ProfileInfoHeaderCollectionReusableView) {
        ...
        for x in 0..<10 {
            mockData.append(UserRelationship(username: "@Joe", name: "Joe Smith", state: x % 2 == 0 ? .following : .notFollowing))
        }
